...
ENV UID=1000 GID=1000 GIT_BRANCH=$GIT_BRANCH GIT_REVISION=$GIT_REVISION DATE=$DATE NB_WORKERS=5 LOG_LEVEL="error" DISABLE_REDIS='false' TARGET_ARCH=$TARGET_ARCH
